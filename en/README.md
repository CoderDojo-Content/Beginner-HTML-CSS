...
9. To the top left of the code window is the name of your project. If you want to change the name, click on it and type in a new name, then press Enter. These Sushi Cards will make a website about Ireland, but yours can be about anything you like.
